...
#    }
#Ash    _defaults = {
#Ash        'type': 'builder.ir.actions.act_url',
#Ash        'target': 'new'
#Ash    }
...
#    _fields = {
    ...
    context = fields.Char('Context Value', required=True, default='{}',
    ...
    target = fields.Selection([('current','Current Window'),('new','New Window'),('inline','Inline Edit'),('inlineview','Inline View')], 'Target Window', default='current',)
    view_mode = fields.Char('View Mode', required=True, default='tree,form',
        help="Comma-separated list of allowed view modes, such as 'form', 'tree', 'calendar', etc. (Default: tree,form)")
    view_type = fields.Selection((('tree','Tree'),('form','Form')), string='View Type', required=True, default='form',
    ...
    #Ash 'views' = fields.function(_views_get_fnc, type='binary', string='Views'
    ...
    multi = fields.Boolean('Restrict to lists', help="If checked and the action is bound to a model, it will only appear in the More menu on list views" , default=False,)
