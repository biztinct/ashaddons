...
import odoo
from odoo import SUPERUSER_ID, netsvc, api, fields, models , tools
...
#    _fields = {
    ...
    interval_type = fields.Selection( [('minutes', 'Minutes'),('hours', 'Hours'), ('work_days','Work Days'), ('days', 'Days'),('weeks', 'Weeks'), ('months', 'Months')], 'Interval Unit', default='months')
