...
class TreeView(models.Model):
    ...
    attr_editable = fields.Selection([('top','top'),('bottom','bottom'),('top/bottom','top/bottom')], 'Inline Editable' )
    #attr_fonts = fields.Char('Fonts', help='Font definition. Ex: bold:message_unread==True', placeholder='bold:message_unread==True')
    #attr_colors = fields.Char('Colors',
    #                          help='Color definition. Ex: "gray:probability == 100;red:date_deadline and (date_deadline &lt; current_date)"',
    #                          placeholder='gray:probability == 100; red:date_deadline and (date_deadline &lt; current_date)')
    attr_fonts = fields.Char('Fonts')
    attr_colors = fields.Char('Decoration')
...
#Ashrevert : Next statement by Ash as defaults above not working
        self.type = 'tree'
        self.subclass_model = 'builder.views.tree'
...
class TreeField(models.Model):
    ...
    #invisible_condition = fields.Char('Invisible Condition', default='[(\'job_type\', \'!=\', \'Material\')]')
